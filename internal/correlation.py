...
def save_scatter(df,x,y,out_folder):
    ...
    plt.scatter(data=df,x='player_fast_block_instructions_info_sum',y='results_goals_diff')
...
def save_corrlation_matrix(title,df,method,x_pref,y_pref,out_folder,x_axis_title_size=0.15,figsize=(9,5)):
    ...
    sns_plot = sns.heatmap(df_corr_pretty,annot=True,linewidths=.5)
    sns_plot.set_title(
